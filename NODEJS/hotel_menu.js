...
const server = http.createServer((req, res) => {
  ...
  if (req.url === "/submit") {
    res.write(`<html>
        ...
        <body>
          <h1>Submit Form</h1>
          <input style="height:30px;" type="text" placeholder="username"/>
          <input style="height:30px;" type="password" placeholder="password"/>
  ...
  if (req.url === "/update") {
    res.write(`<html>
        ...
        <body>
          ...
          <input style="height:30px;" type="text" placeholder="username"/>
          <input style="height:30px;" type="password" placeholder="password"/>
          <button style="height:30px; background-color: lightblue; margin-left:35px;">Update</button>
        </body>
      </html>`);
    return res.end();
  }
